...
toolchains_dir="/home/igor/android/toolchains"
toolchain_name="arm-eabi-4.9"

# Now, name of the configuration file...
defconfig_name="geefhd_defconfig"
